      ...
      <div className="max-w-3xl mx-auto">
        <div className="reveal">
          ...
          <p className="text-white font-semibold mb-10" style={{ fontSize: "1.1rem" }}>
            Por <strong style={{ color: "#FF6D29" }}>12x de R$25,55</strong>, você para de perder tempo com isso hoje.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a href="https://pay.kiwify.com.br/ZBIgHVx" target="_blank" rel="noopener noreferrer" className="btn-primary" style={{ fontSize: "1.05rem", padding: "16px 36px" }}>
