    ...
    <section id="como-funciona" className="py-24 px-6" style={{ background: "#f5f0eb" }}>
      <div className="max-w-5xl mx-auto">
        <div className="reveal text-center mb-16">
          ...
          >
            <span className="md:hidden">Três passos.<br /><span style={{ color: "#FF6D29" }}>Menos de 1 minuto.</span></span>
            <span className="hidden md:inline">Três passos. <span style={{ color: "#FF6D29" }}>Menos de 1 minuto.</span></span>
          </h2>
