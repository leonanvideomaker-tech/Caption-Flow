...
const ANCHOR_ROWS = [
  ...
  { label: "Vídeo aulas passo a passo", value: "R$199", bonus: false },
  ...
  { label: "Bônus — Vídeo aula estilização + presets", value: "R$149", bonus: true },
  { label: "Bônus — Masterclass Criativo Viral", value: "R$200", bonus: true },
];
